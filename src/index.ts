...
function paperRegular() {
  themeWriter("Paper", { ...commonColors, ...regularColors }, semanticRules, textmateRules);
}
...
function paperContrast() {
  themeWriter("Paper Contrast", { ...commonColors, ...contrastColors }, semanticRules, textmateRules);
}

function paperContrastItalic() {
  themeWriter(
    "Paper Contrast Italic",
